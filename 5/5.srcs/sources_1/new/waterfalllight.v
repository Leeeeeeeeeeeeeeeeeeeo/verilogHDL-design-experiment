...
always @(posedge clk or posedge rst) begin
    if (rst) begin
        ...
        case (main_counter)
            // 状态1: 奇偶闪烁4次 (0-7秒)
            6'd0, 6'd2, 6'd4, 6'd6: led <= 16'b1010_1010_1010_1010; // 奇数位亮
            6'd1, 6'd3, 6'd5, 6'd7: led <= 16'b0; // 全灭
            ...
            // 状态4: 奇偶闪烁4次 (40-47秒)
            6'd40, 6'd42, 6'd44, 6'd46: led <= 16'b1010_1010_1010_1010; // 奇数位亮
            6'd41, 6'd43, 6'd45, 6'd47: led <= 16'b0; // 全灭
