...
HD_PWD='/home/leo/vivado_project/3_2/3_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Dec_Add_Sub_CNTR.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Dec_Add_Sub_CNTR.tcl
